...
[Svelte](/docs/svelte)[SvelteKit](/docs/kit)[CLI](/docs/cli)[AI](/docs/ai)

[Tutorial](/tutorial)[Packages](/packages)[Playground](/playground)[Blog](/blog)

[](/chat)[](https://bsky.app/profile/svelte.dev)[](https://github.com/sveltejs)
...
*   ### Template syntax
    ...
    *   [{@attach ...}](/docs/svelte/@attach)
    *   [{@const ...}](/docs/svelte/@const)
    *   [{@debug ...}](/docs/svelte/@debug)
    *   [{let/const ...}](/docs/svelte/declaration-tags)
...
*   ### Runtime
    ...
    *   [Hydratable data](/docs/svelte/hydratable)
*   ### Misc
    
    *   [Best practices](/docs/svelte/best-practices)
    *   [Testing](/docs/svelte/testing)
    *   [TypeScript](/docs/svelte/typescript)
    *   [Custom elements](/docs/svelte/custom-elements)
    *   [Browser support](/docs/svelte/browser-support)
