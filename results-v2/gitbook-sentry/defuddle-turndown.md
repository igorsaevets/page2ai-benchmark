...
Your agent will set up Sentry in your Browser JavaScript app automatically. Works with Cursor, Claude Code, Codex, and more.[View docs ↗](https://docs.sentry.io/ai/agent-plugin/)
