...
[Discord](https://biomejs.dev/chat) [GitHub](https://github.com/biomejs/biome) [Mastodon](https://fosstodon.org/@biomejs) [Open Collective](https://opencollective.com/biome) [YouTube](https://youtube.com/@Biomejs) [BlueSky](https://bsky.app/profile/biomejs.dev) [RSS](https://biomejs.dev/blog/rss.xml)
...
There are also [community extensions](/editors/third-party-extensions) for other editors, such as **Vim**, **Neovim**, and **Sublime Text**, to name a few.
