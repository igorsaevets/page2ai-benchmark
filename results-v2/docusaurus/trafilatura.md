...
## Fast Track ⏱️[](https://docusaurus.io#fast-track)
...
## Docusaurus: Documentation Made Easy[](https://docusaurus.io#docusaurus-documentation-made-easy)
...
## Migrating from v1[](https://docusaurus.io#migrating-from-v1)
...
## Features[](https://docusaurus.io#features)

Docusaurus is built with high attention to the developer and contributor experience.

- ⚛️ **Built with 💚 and React**:- Extend and customize with React
...
- ✂️ **Developer experience**:- Start writing your docs right now
...
## Design principles[](https://docusaurus.io#design-principles)
...
## Comparison with other tools[](https://docusaurus.io#comparison-with-other-tools)
...
### Gatsby[](https://docusaurus.io#gatsby)
...
### Next.js[](https://docusaurus.io#nextjs)
...
### VitePress[](https://docusaurus.io#vitepress)
...
### MkDocs[](https://docusaurus.io#mkdocs)
...
### Docsify[](https://docusaurus.io#docsify)
...
### GitBook[](https://docusaurus.io#gitbook)
...
### Jekyll[](https://docusaurus.io#jekyll)
...
### Rspress[](https://docusaurus.io#rspress)
...
## Staying informed[](https://docusaurus.io#staying-informed)

## Something missing?[](https://docusaurus.io#something-missing)
