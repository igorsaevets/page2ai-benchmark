...
4. [fetch()](/en-US/docs/Web/API/Window/fetch)
...
* [Deutsch](/de/docs/Web/API/Window/fetch)
* [English (US)](/en-US/docs/Web/API/Window/fetch)
* [Español](/es/docs/Web/API/Window/fetch)
* [Français](/fr/docs/Web/API/Window/fetch)
* [日本語](/ja/docs/Web/API/Window/fetch)
* [한국어](/ko/docs/Web/API/Window/fetch)
* [Português (do Brasil)](/pt-BR/docs/Web/API/Window/fetch)
* [Русский](/ru/docs/Web/API/Window/fetch)
* [中文 (简体)](/zh-CN/docs/Web/API/Window/fetch)
...
1. [Fetch API](/en-US/docs/Web/API/Fetch_API)
...
7. Related pages for Fetch API
   1. [`DeferredRequestInit`](/en-US/docs/Web/API/DeferredRequestInit)
   2. [`FetchLaterResult`](/en-US/docs/Web/API/FetchLaterResult)
   3. [`Headers`](/en-US/docs/Web/API/Headers)
   4. [`Request`](/en-US/docs/Web/API/Request)
   5. [`RequestInit`](/en-US/docs/Web/API/RequestInit)
   6. [`Response`](/en-US/docs/Web/API/Response)
   7. [`Window.fetch()`](/en-US/docs/Web/API/Window/fetch)
   8. [`Window.fetchLater()`](/en-US/docs/Web/API/Window/fetchLater)
   9. [`WorkerGlobalScope.fetch()`](/en-US/docs/Web/API/WorkerGlobalScope/fetch)
8. Guides
   1. [Using the Fetch API](/en-US/docs/Web/API/Fetch_API/Using_Fetch)
   2. [Using Deferred Fetch](/en-US/docs/Web/API/Fetch_API/Using_Deferred_Fetch)
