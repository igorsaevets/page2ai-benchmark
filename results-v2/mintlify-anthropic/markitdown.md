...
[API reference](/docs/en/api/overview)English[Console](/)[Log in](/login?returnTo=%2Fdocs%2Fen%2Fbuild-with-claude%2Fextended-thinking)
...
MessagesExtended thinking (legacy)
...
Learn how thinking works: blocks, display, streaming, and tool use.](/docs/en/build-with-claude/thinking)[Steering thinking

Let Claude decide when and how much to think on each request.](/docs/en/build-with-claude/thinking-steering-and-cost)[

Thinking in tool and multi-turn workflows

Preserve thinking blocks and manage thinking across tool calls and turns.](/docs/en/build-with-claude/thinking-tool-workflows)
...
* [Budget rules and tuning](#budget-rules-and-tuning)
* [Interleaved thinking in manual mode](#interleaved-thinking)
* [Turn structure in manual mode](#turn-structure-in-manual-mode)
* [Prompt caching in manual mode](#extended-thinking-with-prompt-caching)
* [Shared mechanics](#shared-mechanics)
* [Migrating to adaptive thinking](#migrating-to-adaptive-thinking)
